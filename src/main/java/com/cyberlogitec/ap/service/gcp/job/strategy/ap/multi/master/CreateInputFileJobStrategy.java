package com.cyberlogitec.ap.service.gcp.job.strategy.ap.multi.master;
...
import com.cyberlogitec.ap.service.gcp.dto.multitrade.TargetRange;
...
public class CreateInputFileJobStrategy implements JobPlugin {
    ...
    public void execute(JobContext<Object> context) throws Exception {
        ...
        this.createFoFiles(payload, partition.start, partition.end, workflowState.getCurrentStepDataKey() + currentTaskIndexStr);
